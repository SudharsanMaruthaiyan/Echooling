...
const MentroCard = ({mentor,domain , name, student, rating }) => {
  return (
    <>
      <div className=" bg-white rounded-lg pt-10 border-2">
        <div className=" flex flex-col items-center justify-center pb-4">
          ...
          <h1 className=" text-[#082a5e] font-bold text-2xl pt-3">{name}</h1>
        ...
        <div className=" flex justify-between py-4 px-5 border-t-2 rounded-b-lg">
          <div className=" flex gap-1">
            ...
            <p className=" font-medium text-slate-600">{student}</p>
          </div>
          <div className=" flex gap-1">
